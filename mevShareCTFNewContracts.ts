import { JsonRpcProvider, keccak256, Wallet, TransactionRequest, toBigInt, Interface, Network, LogParams, AbiCoder, AddressLike } from 'ethers'
...
// import MevShareCTFNewContracts from './abis/MevShareCTFNewContracts.json'
...
const sendTestBackrunBundle = async (
    ...
    const childContractAddress = abiCoder.decode(['address'], log.data)[0]
    console.log("child contract addresses: ", childContractAddress);
...
const handleBackrun = async (
    ...
    if (pendingTx.logs && pendingTx.logs[0].address == "0x5ea0fea0164e5aa58f407debb344876b5ee10dea" &&
        pendingTx.logs[0].topics.includes("0xf7e9fe69e1d05372bc855b295bc4c34a1a0a5882164dd2b26df30a26c1c8ba15")
    ){
